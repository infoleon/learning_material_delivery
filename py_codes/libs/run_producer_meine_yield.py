...
def run_producer_yield(sim_fs, site_fs, crop_fs, weather_fs, path_dir, path_env, weather_header_order,
                 len_points, sla, outros, fit = True):
    ...
    for i in range(leng):
        ...
        if fit:
            #print("entered fit")
            env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["cultivar"]["SpecificLeafArea"][0] = sla
            env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["cultivar"]["MaxAssimilationRate"] = outros[0]
            env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["species"]["RootPenetrationRate"]  = outros[1]
            
            #print(env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["cultivar"]["SpecificLeafArea"][0])
            #print(env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["cultivar"]["MaxAssimilationRate"])
            #print(env["cropRotation"][0]["worksteps"][1]["crop"]["cropParams"]["species"]["RootPenetrationRate"])
