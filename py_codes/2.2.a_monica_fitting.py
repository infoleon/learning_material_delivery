...
if __name__ == '__main__':
    ...
    if save_output_stop:
        ...
        params = [-3.2325, 5.7082, 119.3750, 379.1683, 176.6966, 340.9521, 350.5179]
        params = [-2.7853, 5.9870, 101.6765, 341.5834, 162.7112, 342.7432, 331.9794]
        ...
        if ML:
            ...
            rounded = [round(x, 4) for x in result.x.tolist()]
